...
globalkeys = awful.util.table.join(
    ...
    awful.key({ modkey,           }, "u",     function () awful.util.spawn("chromium-browser") end),
    awful.key({ modkey, "Shift"   }, "u",     function () awful.util.spawn("chromium-browser --incognito --proxy-server=localhost:8123") end),
