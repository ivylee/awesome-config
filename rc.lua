...
beautiful.init("/home/ivy/.config/awesome/theme.lua")
...
globalkeys = awful.util.table.join(
    ...
    awful.key({ modkey, "Shift"   }, "g",     function () awful.util.spawn("gpodder") end),
    awful.key({ modkey,           }, "p",     function () awful.util.spawn("pidgin") end),
    awful.key({ modkey,           }, "s",     function () awful.util.spawn("skype") end),
    awful.key({ modkey, "Shift"   }, "s",     function () awful.util.spawn("shotwell") end),
    awful.key({ modkey,           }, "v",     function () awful.util.spawn("VirtualBox") end),
    awful.key({ modkey,           }, "u",     function () awful.util.spawn("google-chrome --incognito") end),
    awful.key({ modkey, "Shift"   }, "u",     function () awful.util.spawn("google-chrome --incognito --proxy-server=localhost:8123") end),
...
awful.rules.rules = {
    ...
    { rule = { instance = "epdfview" }, 
      properties = { tag = tags[1][4] } },
    { rule = { instance = "shotwell" },
      properties = { tag = tags[1][4] } },
    { rule = { name = "VirtualBox" }, 
      properties = { tag = tags[1][5] } },
    { rule = { instance = "gsopcast" }, 
